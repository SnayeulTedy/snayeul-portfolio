...
// ── Réseaux sociaux — remplace les # par tes vrais liens ──
const socials = [
  {
    label: "Instagram",
  ...
  return (
    <section id="about" className="border-t border-blue-500/20 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-16 sm:py-24">
        ...
        <div className="border border-blue-500/20 overflow-hidden mb-6">
          <div className="px-3 py-2 bg-blue-500/10 border-b border-blue-500/20">
            <span className="font-mono text-[10px] text-blue-400 uppercase tracking-widest">
              &gt; INFORMATIONS
            </span>
          ...
          <div className="flex">
            {socials.map((s, i) => (
              <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" title={s.label}
                className={`flex flex-col items-center justify-center gap-2 py-5 flex-1 text-gray-500 hover:text-blue-400 hover:bg-blue-500/5 transition-colors
